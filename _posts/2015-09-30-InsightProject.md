...
author:
  - bethstankevich
---
For the TLDR version, check out my [slides](https://www.slideshare.net/secret/rk6o5EbMimnLFR "slides").  
Check out my Github for the [code](https://github.com/bstankev/insight_notebooks "code"). 
